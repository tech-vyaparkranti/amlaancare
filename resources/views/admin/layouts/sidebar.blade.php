<div class="main-sidebar sidebar-style-2">
    ...
    <a href="">{{ $settings->site_name ?? 'Site Name' }}</a>
</div>
        ...
        <ul class="sidebar-menu">
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    {{-- <li class="{{ setActive(['admin.font-master.*']) }}"><a class="nav-link" href="{{ route('admin.font-master.index') }}">Product Font Master</a></li>
                    <li class="{{ setActive(['admin.product-colour-master.*']) }}"><a class="nav-link" href="{{ route('admin.product-colour-master.index') }}">Product Colour Master</a></li> --}}
                    <li
                        class="{{ setActive([
                            'admin.product-collections.*',
                        ]) }}">
                        <a class="nav-link" href="{{ route('admin.product-collections.index') }}">Product Collections</a>
                    </li>
                    <li>
                        <a class="nav-link" href="{{ route('manageBatch') }}">Manage Batch</a>
                    </li>
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    {{-- <li class="{{ setActive(['admin.dynamic.*']) }}"><a class="nav-link"
                            href="{{ route('admin.dynamic.index') }}">Dynamic</a></li> --}}
            ...
            <li class="dropdown {{ setActive([
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.shipping-policy.index']) }}"><a class="nav-link" href="{{ route('admin.shipping-policy.index') }}">Shipping Policy</a></li>
                    <li class="{{ setActive(['admin.privacy-policy.index']) }}"><a class="nav-link" href="{{ route('admin.privacy-policy.index') }}">Privacy Policy</a></li>
                    <li class="{{ setActive(['admin.cancellation-policy.index']) }}"><a class="nav-link" href="{{ route('admin.cancellation-policy.index') }}">Cancellation Policy</a></li>

                    <!-- Added "Manage Home" here -->
                    <li>
                        <a class="nav-link" href="{{ route('manageHome') }}">Manage Home</a>
                    </li>
                    <li>
                        <a class="nav-link" href="{{ route('manageSupplyChain') }}">Manage supply chain</a>
                    </li>


                    <li>
                        <a class="nav-link" href="{{ route('manageCertifications') }}">Our Certifications</a>
                    </li>

                    <li>
                        <a class="nav-link" href="{{ route('faq.index') }}">Home Page FAQ</a>
                    </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.footer-menu.*']) }}"><a class="nav-link"
                            href="{{ route('admin.footer-menu.index') }}">Footer Menu</a></li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.customer.exiturl']) }}"><a class="nav-link"
                            href="{{ route('admin.customer.exiturl') }}">Customer exit url</a></li>
