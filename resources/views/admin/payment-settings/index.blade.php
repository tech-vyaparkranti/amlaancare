                      ...
                      <div class="row">
                        <div class="col-2">
                          <div class="list-group" id="list-tab" role="tablist">
                            ...
                            <a class="list-group-item list-group-item-action" id="list-razorpay-list" data-toggle="list" href="#list-cashfree" role="tab">CashFree</a>
                        ...
                        <div class="col-10">
                          <div class="tab-content" id="nav-tabContent">
                            ...
                            @include('admin.payment-settings.sections.cashfree-setting')
