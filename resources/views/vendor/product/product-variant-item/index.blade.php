        ...
        <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
          ...
          <div class="dashboard_content mt-2 mt-md-0">
            ...
            <div class="create_button">
                <a href="{{route('vendor.products-variant-item.create', ['productId' => $product->id, 'variantId' => $variant->id])}}" class="btn btn-primary common_btn"><i class="fas fa-plus"></i> Create Variant Item</a>
            </div>
