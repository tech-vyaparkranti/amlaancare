...
@section('content')
    ...
    <section id="product_page">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="pro_page_bammer vendor_det_banner">
                        <img src="{{asset('frontend/images/vendor_details_banner.jpg')}}" alt="banner" class="img-fluid w-100">
                        <div class="pro_page_bammer_text vendor_det_banner_text">
                            <div class="vendor_text_center">
                                ...
                                <p class="vendor_location"><i class="fal fa-map-marker-alt"></i> {{$vendor->address}}</p>
                            ...
                            <div class="col-xl-6 col-12 col-sm-10 col-md-8 col-lg-6 m-auto display">
                                <div class="quick_view_img">
                                    @if ($product->video_link)
                                        <a class="venobox pro_det_video" data-autoplay="true" data-vbtype="video"
