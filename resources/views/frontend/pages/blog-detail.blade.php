                            ...
                            <div class="row blog_det_slider">
                                ...
                                <div class="col-xl-3">
                                    <div class="single_blog single_blog_2">
                                        <a class="blog_img" href="{{route('blog-details', $blogItem->slug)}}">
                    ...
                    <div class="blog_sidebar" id="sticky_sidebar">
                        ...
                        <div class="blog_post">
                            ...
                            <div class="blog_post_single">
                                <a href="{{route('blog-details', $blog->slug)}}" class="blog_post_img">
