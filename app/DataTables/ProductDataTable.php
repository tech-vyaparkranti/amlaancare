...
class ProductDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('type', function($query){
                switch ($query->product_type) {
                    ...
                    case 'best_product':
                        ...
                        break;
                    case 'latest_product':
                        return '<i class="badge badge-danger">Latest Product</i>';
                        break;
                    case 'best_seller_product':
                        return '<i class="badge badge-danger">Best Seller Product</i>';
                        break;
            ...
            ->addColumn('category', fn($query) => $query->category?->name ?? 'N/A')
            ->addColumn('brand', fn($query) => $query->brand?->name ?? 'N/A')
    ...
    {
        return $model->with(['category', 'brand'])->where('vendor_id', Auth::user()->vendor?->id)->newQuery();
    }
