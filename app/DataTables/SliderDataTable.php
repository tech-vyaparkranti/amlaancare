...
class SliderDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('mobile_banner', function($query){
              return $img = "<img width='100px' src='".asset($query->mobile_banner)."' ></img>";
            })
            ...
            ->rawColumns(['banner','mobile_banner', 'action', 'status'])
            ->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('mobile_banner')->width(200),
            Column::make('title'),
            Column::make('serial'),
            Column::make('status'),
