...
class LoginRequest extends FormRequest
{
    ...
    {
        return [
            'phone' => ['required','digits:10', 'string'],
    ...
    public function authenticate(): void
{
    ...
    // ✅ Fix CSRF mismatch on first login
    session()->regenerate();         // Regenerates session ID
...
//     $user = \App\Models\User::where('phone', $this->input('phone'))->first();
