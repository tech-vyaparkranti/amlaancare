...
class VendorController extends Controller
{
    public function dashboard()
    {
        ...
        //     return redirect()->route('home'); // Redirect to login if user is not authenticated or has no vendor
        // }

        // // Retrieve the user's vendor ID
        // $vendorId = Auth::user()->vendor->id;

        // // Proceed with the query to count today's orders for the vendor
