...
use App\Http\Controllers\Backend\FontMasterController;
...
use App\Http\Controllers\Backend\CashFreeSettingController;
use App\Http\Controllers\Backend\ProductCollectionController;
use App\Http\Controllers\Backend\ProductVariantItemController;
use App\Http\Controllers\Backend\ProductColourMasterController;
use App\Http\Controllers\Backend\ProductImageGalleryController;
use App\Http\Controllers\ProductCollectionMappingController;
...
/** dynamic routes */
Route::get('dynamic', [FlashSaleController::class, 'index'])->name('dynamic.index');
...
Route::get('advertisements', [AdvertisementController::class, 'homepage'])->name('advertisement.homepage');

/**customer exit tracking */

Route::get('CustomerExit', [ExitTrackerController::class, 'exiturl'])->name('customer.exiturl');
...
Route::put('shipping-policy/update', [ShippingPolicyController::class, 'update'])->name('shipping-policy.update');

Route::get('privacy-policy', [PrivacyPolicyController::class, 'index'])->name('privacy-policy.index');
Route::put('privacy-policy/update', [PrivacyPolicyController::class, 'update'])->name('privacy-policy.update');

Route::get('cancellation-policy', [CancellationPolicyController::class, 'index'])->name('cancellation-policy.index');
Route::put('cancellation-policy/update', [CancellationPolicyController::class, 'update'])->name('cancellation-policy.update');
...
Route::put('footer-menu/change-status', [FooterMenuController::class, 'changeStatus'])->name('footer-menu.change-status');
Route::put('footer-menu/change-title', [FooterMenuController::class, 'changeTitle'])->name('footer-menu.change-title');
...
Route::resource('cashfree-setting', CashFreeSettingController::class);


Route::resource('font-master', FontMasterController::class);

Route::resource('product-colour-master', ProductColourMasterController::class);

//product-collections
Route::resource('product-collections', ProductCollectionController::class);
Route::put('product-collections-change-status', [ProductCollectionController::class, 'changeStatus'])->name('product-collections.change-status');
Route::resource('product-collections-manage', ProductCollectionMappingController::class);

Route::get('/manage-home', [ManageHomeController::class, 'manageHome'])->name('admin.manage-home');
